...
"""
Class to read out the DHT11 humidity/temperature sensor via a gpio pin
...
class DHT11:
    ...
    def measure(self):
        ...
        # data is contained in the last 40 high signals
        counts = counts[-40:]
        ...
        if checksum == calculated_checksum:
            ...
            self.temperature = byte_values[2] + (byte_values[3] & 0x0f) * 0.1
            
            if byte_values[3] & 0x80:
                self.temperature *= -1

if __name__ == "__main__":
    dht11 = DHT11(17) # assume gpio 17
    dht11.measure()

    if dht11.humidity != None:
        print("humidity : %.1f%%" % dht11.humidity)
        print("temperature : %.1fC" % dht11.temperature)
